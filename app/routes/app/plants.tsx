					...
					<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						...
						<div className="flex">
							<p className="mt-2 text-sm text-gray-700 flex-1">
								The available plants on your farm. Create plants before planning
								out your season.
							</p>
...
function EmptyPlants() {
	return (
		<div className="text-center bg-white p-16 shadow-sm rounded-md mx-8">
			<h3 className="mt-2 text-sm font-semibold text-gray-900">No plants</h3>
			<p className="mt-1 text-sm text-gray-500">
				Add a plant into the system. You'll be able to use the plant when
				planning your fields and sowing schedules.
			</p>
			<div className="mt-6">
				<Link
					to="/app/plants/new"
